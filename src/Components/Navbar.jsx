  ...
  return (
    <>
      <nav className="flex flex-col sm:flex-row justify-between items-start sm:items-center px-5 py-5  shadow-md fixed top-0 left-0 right-0 bg-white gap-1 sm:gap-0">
        ...
        <img src="/picprismlogo.png" alt="" className="w-full h-[9vh]"/>       
        <Link to={"/"} className="text-3xl font-bold"> PicPrism </Link>
        </div>

        <ul className="flex flex-row justify-center items-center font-semibold  gap-5 text-lg    text-gray-500 ps-4 sm:pe-0  ">
