  ...
  return (
    <>
      <nav
        ...
        } min-h-screen w-fit shadow-lg py-6 px-5 flex flex-col gap-4 items-start text-md sm:text-lg ease-in-out duration-500 sm:static bg-white`}
      >
        <div className="text-lg text-bold text-white bg-black rounded-full ml-3 py-3 px-5 justify-start">
          {author && author.charAt(0).toUpperCase()}
        </div>
        <div className="h-[84vh] w-fit flex justify-between items-start flex-col">
          <div className="flex justify-between items-start flex-col gap-2">
            ...
            <div
              className={`flex justify-start w-full items-center text-md sm:text-lg font-semibold hover:bg-black hover:text-white transition-all ease-linear duration-150 transform py-2 px-4 rounded-lg cursor-pointer ${
